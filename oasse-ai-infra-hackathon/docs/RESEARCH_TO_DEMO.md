...
The GOI work is not used as a robotics safety premise or hackathon scoring claim. Its relevance is methodological: preserve the distinction between observed state, admissible transformation, unresolved information, and physical effect; expose no-go results; and attach falsifiers rather than making the system depend on narrative certainty.
